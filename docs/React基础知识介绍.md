...
推荐阅读[es6入门](http://es6.ruanyifeng.com/)
...
**这里`import React from 'react'`引用的是什么？**
...
React 详细的生命周期可参见[这里](http://reactjs.cn/react/docs/component-specs.html)，这里我们重点介绍这个项目开发中常用的几个生命周期函数（hook），相信你在接下来的 React 开发中，也会常用这些。
